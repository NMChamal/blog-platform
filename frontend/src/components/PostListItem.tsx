...
const PostListItem = ({ post }: PostListItemProps) => {
  ...
  return (
    <div className="p-4 border rounded-lg shadow-sm h-48 flex flex-col transition-transform duration-200 transform hover:scale-105">
      ...
      <div className="mt-2 flex-grow overflow-hidden">{parse(post.content.replace(/src="\/uploads/g, `src="${import.meta.env.VITE_API_BASE_URL}/uploads`).substring(0, 200), options)}...</div>
